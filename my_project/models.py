...
class Webpage(models.Model):
    ...
    def __str__(self):
        return self.address
        #
        #     +"~"+str(self.errorType)+"~"+str(self.h1Count)+"~"+str(self.h2Count)+"~"+str(self.h3Count)+"~"+st
        # r(self.h4Count)+"~"+str(self.h5Count)+"~"+str(self.h6Count)+"~"+self.version+"~"
        # +str(self.internalLinkCount)+"~"+str(self.externalLinkCount)+"~
        # "+self.title+"~"+str(self.inaccessibleLinkCount)+"~"+str(self.statusCode)+"~"+str(self.timeStamp)+"~"+
        # str(self.loginForm)+"~"+str(self.errorMessage)
